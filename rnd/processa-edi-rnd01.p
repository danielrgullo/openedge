...
/* alterar a data aqui ? */
             ...
             * Temos que tirar 3 dias, pois é esse o tempo que leva
             * para a carga chegar lá ... e a data de entrega enviada
             * é a data para estar lá e não sair daqui !!!
             * Mantive a data de janela original para referencia! Decisão minha!!
             * Mas não é janela realmente!!!!!!
             */
